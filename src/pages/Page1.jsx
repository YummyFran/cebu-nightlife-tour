        ...
        <div className="main">
            ...
            <div className="container">
                <div className='wrapper'>
                    ...
                    <p className="line">
                        사실 필리핀 밤문화가 화려하고 한국보다 <br />
                        더 많은 업소가 즐비할 것 같지만 업소 숫자나 <br />종사자 수로 보나 한국이
                    </p>
                    ...
                    <p className="line">
                        만약에 세부밤문화를 즐기는 도중에도 <br />
                        한국은 짦은 시간에 만남이 쉽게 마무리 된다면 <br />필리핀은 그에 비해</p>
                    <p className="line">맘에 들면 긴 시간동안 같이 지낼수가 있지요</p>
                    <p className="line">빈부격차가 한국보다 훨씬 심하기 때문에</p>
                    <p className="line">한국보다 금액을 덜 투자해도 매너 좋고</p>
                    <p className="line">외모가 깔끔하다면 필리핀 <br />여자의마음을 얻기 쉬운데요</p>
                    <p className="line">예전보다 소득도 높아지고 <br />인터넷 보급으로 한국 미남이</p>
                    <p className="line">현지에서도 미남으로 통하기 때문에</p>
                    <p className="line">젊고 잘생기면 현지에서 황제처럼 <br />즐길수도 있답니다.</p>
                    <p className="line">​그럼 필리핀 여자에 대한 <br />선입견이 있다면 무었일까요?</p>
                    <p className="line">피부가 까맣고 외모가 많이 못생기고 못배우고 등등</p>
                    <p className="line">아주 많은 편견과 선입견이 있는데요</p>
                    <p className="line">그중 몇개는 맞지만 필리핀 <br />여자가 못생긴건 절대 아닙니다.</p>

                    <img src="/banner2.jpg" alt="banner2" className='banner' />

                    <p className='line'>빈곤층은 영양수준이 낮고 제대로 관리를 받지못해</p>
                    <p className='line'>외모가 부족할 순 있지만 <br />최근에는 생활수준도 향상되고</p>
                    <p className='line'>관리도 잘해서 패션, 몸매, 얼굴 <br />아주 매력적이랍니다.</p>
                    <p className='line'>전세계 여러개의 미인 대회에서 여러번 일등하는</p>
                    <p className='line'>몇 안되는 나라가 바로 필리핀 <br />여자라는 사실 아시나요?</p>

                    <img src="/banner3.jpg" alt="banner3" className='banner' />

                    <p className="line">오래전부터 스페인 식민지, <br />중간에 미국, 일본 식민지</p>
                    ...
                    <p className="line">가수중에 필리핀 혼혈들이 <br />찾아보면 정말 많이 있습니다.</p>
                    ...
                    <p className='line'>서로에게 피해를 주지 않고 잊지 못할  <br />추억 만드실 수 있으실겁니다.</p>
                </div>
            </div>
        </div>
    )
