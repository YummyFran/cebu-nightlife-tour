      ...
      <div className="container">
        ...
        <ul className={`${isMenuOpen ? "open" : ""}`}>
          ...
          <li><NavLink to={'/'} className={({ isActive }) => `${isActive ? 'active' : ''} header-pc`}>
            ...
            세부밤문화</NavLink></li>
          <li><NavLink to={'/philippine-nightlife'} className={({ isActive }) => isActive ? 'active' : ''}>필리핀 여자와 필리핀 밤문화</NavLink></li>
          <li><NavLink to={'/filipino-personality'} className={({ isActive }) => isActive ? 'active' : ''}>필리핀사람들의 성격 및 특징</NavLink></li>
